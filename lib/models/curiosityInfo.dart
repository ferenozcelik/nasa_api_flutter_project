...
//
//     final curiosityPhotos = curiosityPhotosFromJson(jsonString);

import 'dart:convert';

CuriosityPhotos curiosityPhotosFromJson(String str) => CuriosityPhotos.fromJson(json.decode(str));

String curiosityPhotosToJson(CuriosityPhotos data) => json.encode(data.toJson());

class CuriosityPhotos {
    CuriosityPhotos({
        this.photos,
    });
    ...
    factory CuriosityPhotos.fromJson(Map<String, dynamic> json) => CuriosityPhotos(

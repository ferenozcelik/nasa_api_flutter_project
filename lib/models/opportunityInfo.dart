...
//
//     final opportunityPhotos = opportunityPhotosFromJson(jsonString);

import 'dart:convert';

OpportunityPhotos opportunityPhotosFromJson(String str) => OpportunityPhotos.fromJson(json.decode(str));

String opportunityPhotosToJson(OpportunityPhotos data) => json.encode(data.toJson());
...
class OpportunityPhotos {
    ...
    factory OpportunityPhotos.fromJson(Map<String, dynamic> json) => OpportunityPhotos(
